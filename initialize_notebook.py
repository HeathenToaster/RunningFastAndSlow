...
def initialize_notebook(root=root, ):
    ...
    GENERAL_PLOT_PARAMS = {'alpha_0':  dict(yticks=[0, 1, 2, 3, 4, 5], yticks_I=[0, 1, 2, 3], yticksdiff=[-0.6, -0.3, 0, 0.3, 0.6], ylabel=r'$\alpha_0$'),
                           ...
                           'alpha_u':  dict(yticks=[-1.5, -1, -0.5, 0, .5], yticks_I=[-1.5, -1, -0.5, 0, .5], yticksdiff=[-0.3, -0.2, -0.1, 0, 0.1, 0.2, 0.3], ylabel=r'$\alpha_u$'),
                           ...
                           'gamma_u':  dict(yticks=[-.6, -.4, -.2, 0, .2], yticks_I=[-.6, -.4, -.2, 0, .2], yticksdiff=[-.2, -.1, 0, .1, .2], ylabel=r'$\gamma_u$'),
                           ...
                           'mu_u':     dict(yticks=[-0.3, -0.2, -.1, 0, .1, .2], yticks_I=[-0.3, -0.2, -.1, 0, .1, .2], yticksdiff=[-0.06, -0.03, 0, 0.03, 0.06], ylabel=r'$\mu_u$'),
                           ...
                           'sigma_u':  dict(yticks=[-.05, 0, .05, .1, .15, .2], yticks_I=[-.05, 0, .05, .1, .15, .2], yticksdiff=[-0.03, -0.02, -0.01, 0, 0.01, 0.02, 0.03], ylabel=r'$\sigma_u$'),
