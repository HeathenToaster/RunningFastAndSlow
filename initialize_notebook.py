...
def initialize_notebook(root=root, ):
    ...
    GENERAL_PLOT_PARAMS = {'alpha_0':  dict(yticks=[0, 1, 2, 3, 4, 5], yticks_I=[0, 1, 2, 3], yticksdiff=[-0.6, -0.3, 0, 0.3, 0.6], ylabel=r'$\alpha_0$'),
                           'alpha_t':  dict(yticks=[-.2, 0, .2, .4, .6], yticks_I=[-.1, 0, .1, .2, .3, .4, .5], yticksdiff=[-.2, -0.15, -0.1, -0.05, 0, 0.05, .1, 0.15], ylabel=r'$\alpha_t$'),
                           'alpha_u':  dict(yticks=[-1.5, -1, -0.5, 0, .5], yticks_I=[-.5, -.25, 0, .25], yticksdiff=[-0.3, -0.2, -0.1, 0, 0.1, 0.2, 0.3], ylabel=r'$\alpha_u$'),
                           'gamma_0':  dict(yticks=[0, 0.5, 1, 1.5, 2], yticks_I=[0, 0.5, 1, 1.5, 2], yticksdiff=[-0.3, -0.2, -0.1, 0, 0.1, 0.2, 0.3], ylabel=r'$\gamma_0$'),
                           'gamma_t':  dict(yticks=[-.2, -.1, 0, .1], yticks_I=[-.15, -.1, -.05, 0, .05], yticksdiff=[-0.04, -.02, 0, 0.02, 0.04, 0.06], ylabel=r'$\gamma_t$'),
                           'gamma_u':  dict(yticks=[-.6, -.4, -.2, 0, .2], yticks_I=[-.5, -.4, -.3, -.2, -.1, 0, .1], yticksdiff=[-.2, -.1, 0, .1, .2], ylabel=r'$\gamma_u$'),
                           'mu_0':     dict(yticks=[0, 1, 2, 3, 4], yticks_I=[0, .5, 1, 1.5, 2, 2.5], yticksdiff=[-0.4, -.2, 0, 0.2, 0.4], ylabel=r'$\mu_0$'),
                           'mu_t':     dict(yticks=[-0.1, 0, .1, .2], yticks_I=[-0.05, 0, .05, .1, .15], yticksdiff=[-0.06, -0.04, -0.02, 0, 0.02, 0.04], ylabel=r'$\mu_t$'),
                           'mu_u':     dict(yticks=[-0.3, -0.2, -.1, 0, .1, .2], yticks_I=[-0.15, -0.1, -.05, 0, .05, .1, .15, .2], yticksdiff=[-0.06, -0.03, 0, 0.03, 0.06], ylabel=r'$\mu_u$'),
                           'sigma_0':  dict(yticks=[0, .1, .2, .3, .4, .5], yticks_I=[0, .05, .1, .15, .2, .25],yticksdiff=[-0.06, -0.03, 0, 0.03, 0.06], ylabel=r'$\sigma_0$'),
                           'sigma_t':  dict(yticks=[-.06, -.03, 0, .03, .06, 0.09], yticks_I=[-.06, -.03, 0, .03, .06, 0.09],yticksdiff=[-0.02, -0.01, 0, 0.01, 0.02], ylabel=r'$\sigma_t$'),
                           'sigma_u':  dict(yticks=[-.05, 0, .05, .1, .15, .2], yticks_I=[-.02, 0, .02, .04, .06, .08, .10, .12], yticksdiff=[-0.03, -0.02, -0.01, 0, 0.01, 0.02, 0.03], ylabel=r'$\sigma_u$'),
