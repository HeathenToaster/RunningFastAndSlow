...
def initialize_notebook(root=root, ):
    ...
    GENERAL_PLOT_PARAMS = {'alpha_0':  dict(yticks=[0, 1, 2, 3, 4, 5], yticks_I=[0, 1, 2, 3], yticksdiff=[-0.6, -0.3, 0, 0.3, 0.6], ylabel=r'$\alpha_0$'),
                           ...
                           'mu_0':     dict(yticks=[0, 1, 2, 3, 4], yticks_I=[.5, 1, 1.5, 2, 2.5], yticksdiff=[-0.4, -.2, 0, 0.2, 0.4], ylabel=r'$\mu_0$'),
                           'mu_t':     dict(yticks=[-0.1, 0, .1, .2], yticks_I=[0, .05, .1, .15, .2], yticksdiff=[-0.06, -0.04, -0.02, 0, 0.02, 0.04], ylabel=r'$\mu_t$'),
